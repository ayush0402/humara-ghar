        ...
        <ul className="flex justify-center gap-2 md:flex-col">
          <li className="flex flex-col items-start font-medium">
            ...
            <button
              ...
              onClick={() => goTo(0)}
              className={`text-sm ${
                currentStepIndex === 0 ? "text-[#16a34a]" : "text-white"
              } md:text-base`}
            >
              <RoughNotation
                type="underline"
          ...
          <li className="flex flex-col items-start font-medium">
            ...
            <button
              ...
              onClick={() => goTo(1)}
              className={`text-sm ${
                currentStepIndex === 1 ? "text-[#16a34a]" : "text-white"
              } md:text-base`}
            >
              <RoughNotation
                type="underline"
          ...
          <li className="flex flex-col items-start font-medium">
            ...
            <button
              ...
              onClick={() => goTo(2)}
              className={`text-sm ${
                currentStepIndex === 2 ? "text-[#16a34a]" : "text-white"
              } md:text-base`}
            >
              <RoughNotation
                type="underline"
          ...
          <li className="flex flex-col items-start font-medium">
            ...
            <button
              ...
              onClick={() => goTo(3)}
              className={`text-sm ${
                currentStepIndex === 3 ? "text-[#16a34a]" : "text-white"
              } md:text-base`}
            >
              <RoughNotation
                type="underline"
          ...
          <li className="flex flex-col items-start font-medium">
            ...
            <button
              ...
              onClick={() => goTo(4)}
              className={`text-sm ${
                currentStepIndex === 4 ? "text-[#16a34a]" : "text-white"
              } md:text-base`}
            >
              <RoughNotation
                type="underline"
